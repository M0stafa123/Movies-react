...
https://api.themoviedb.org/3/movie/${id}?api_key=9ca882c0d9271bac0450ebcb904575b0`);
  return (
    <main className="w-4/5 mx-auto p-5 mt-5">
      {Movies && (
        <article>
          <div className=" flex justify-around items-center bg-[#FEC0C0] rounded-lg p-3">
          ...
          <div className="flex justify-around p-3 mt-4">
            <Link
              className="rounded-md w-40 text-center text-white active:bg-[#FEC0C0] hover:bg-[#AA0C23] active:text-black p-1 bg-[#D62433]"
              to={Movies.homepage}
            >
              See Movie
            </Link>
